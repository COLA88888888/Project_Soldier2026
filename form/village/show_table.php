...
$i = 1;
include('../../condb.php');
$stmt = $conn->prepare("SELECT a.*,b.*,c.* FROM province as a,distict as b,village as c where a.pro_id = b.pro_id AND b.dis_id = c.dis_id");
$stmt->execute();
...
<?php if ($_SESSION['role'] == "admin") { ?>
<td>
<a href="show_table.php?v_id=<?= $row['v_id'] ?>" class="btn btn-danger btn-sm delete">
<i class="fas fa-trash"></i> ລົບ
</a>
<a href="edit.php?v_id=<?= $row['v_id'] ?>" class="btn btn-primary btn-sm edit">
