...
$i = 1;
include('../../condb.php');
$stmt = $conn->prepare("SELECT a.*,b.*,c.*,d.* FROM  province  as a,distict as b,village as c,users as d where a.pro_id = b.pro_id AND b.dis_id = c.dis_id AND c.v_id = d.v_id ");
$stmt->execute();
