...
$count = mysqli_query($conn,"select count(b.officer_id)as totallss from panak as a,officers as b where a.officer_id =b.officer_id  and a.pk_name='$pk_name'  and b.gender_hp='ຊາຍ' ");
$totallss =mysqli_fetch_array($count);

$countw = mysqli_query($conn,"select count(b.officer_id)as totallsws from panak as a,officers as b where a.officer_id =b.officer_id  and a.pk_name='$pk_name'  and b.gender_hp='ຍິງ' ");
$totallsws =mysqli_fetch_array($countw);

$countf = mysqli_query($conn,"select count(b.officer_id)as totallsfs from panak as a,officers as b where a.officer_id =b.officer_id  and a.pk_name='$pk_name'  and b.status_persions='ຄອບຄົວ' ");
$totallsfs =mysqli_fetch_array($countf);

$counting = mysqli_query($conn,"select count(b.officer_id)as totallsings from panak as a,officers as b where a.officer_id =b.officer_id  and a.pk_name='$pk_name'  and b.status_persions='ໂສດ' ");
...
while($row=mysqli_fetch_array($sql)){ 
    $l_name = $row['l_name'];
$m = mysqli_query($conn,"SELECT a.*,b.*, count(b.hp_id)as tom from positions_level as a,officers as b where a.l_id =b.l_id  and a.l_name='$l_name' and b.gender='ຊາຍ' and b.dateh_hp");
$tom =mysqli_fetch_array($m);

$m = mysqli_query($conn,"SELECT a.*,b.*, count(b.hp_id)as tof from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name' and b.gender='ຍິງ' and b.dateh_hp");
$tof =mysqli_fetch_array($m);

$family = mysqli_query($conn,"SELECT a.*,b.*, count(b.hp_id)as tofamily from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name' and b.status_persions='ຄອບຄົວ' and b.dateh_hp");
$tofamily =mysqli_fetch_array($family);

$single = mysqli_query($conn,"SELECT a.*,b.*, count(b.hp_id)as tosingle from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name' and b.status_persions='ໂສດ' ");
$tosingle =mysqli_fetch_array($single);
    ?>
<tr align="center">
<th><?php echo $i++; ?></th>
...
while($row=mysqli_fetch_array($sql)){ 
    $l_name = $row['l_name'];
$m = mysqli_query($conn,"SELECT a.*,b.*, count(b.officer_id)as tom from positions_level as a,officers as b where a.l_id =b.l_id  and a.l_name='$l_name' and b.gender='ຊາຍ' and b.dateh_hp");
$tom =mysqli_fetch_array($m);

$m = mysqli_query($conn,"SELECT a.*,b.*, count(b.officer_id)as tof from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name' and b.gender='ຍິງ' and b.dateh_hp");
$tof =mysqli_fetch_array($m);

$family = mysqli_query($conn,"SELECT a.*,b.*, count(b.officer_id)as tofamily from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name' and b.status_persions='ຄອບຄົວ' and b.dateh_hp");
$tofamily =mysqli_fetch_array($family);
...
$count = mysqli_query($conn,"select count(b.officer_id)as totalls5 from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name'  and b.gender='ຊາຍ' and b.dateh_hp ");
$totalls5 =mysqli_fetch_array($count);

$countw = mysqli_query($conn,"select count(b.officer_id)as totallsw5 from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name'  and b.gender='ຍິງ' and b.dateh_hp ");
$totallsw5 =mysqli_fetch_array($countw);

$countf = mysqli_query($conn,"select count(b.officer_id)as totallsf5 from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name'  and b.status_persions='ຄອບຄົວ' and b.dateh_hp ");
$totallsf5 =mysqli_fetch_array($countf);

$counting = mysqli_query($conn,"select count(b.officer_id)as totallsing5 from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name'  and b.status_persions='ໂສດ' and b.dateh_hp ");
...
<th><?php echo $row['l_name']; ?></th>
<th><?php echo $tom['totalls5']; ?> ສະຫາຍ</th>
<th><?php echo $tof['totallsw5']; ?> ສະຫາຍ</th>
<th><?php echo $tofamily['totallsf5']; ?> ສະຫາຍ</th>
<th><?php echo $tosingle['totallsing5']; ?> ສະຫາຍ</th>
...
$count = mysqli_query($conn,"select count(b.officer_id)as totalls6 from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name'  and b.gender='ຊາຍ'  and b.dateb_hp ");
$totalls6 =mysqli_fetch_array($count);

$countw = mysqli_query($conn,"select count(b.officer_id)as totallsw6 from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name'  and b.gender='ຍິງ'  and b.dateb_hp ");
$totallsw6 =mysqli_fetch_array($countw);

$countf = mysqli_query($conn,"select count(b.officer_id)as totallsf6 from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name'  and b.status_persions='ຄອບຄົວ'  and b.dateb_hp ");
$totallsf6 =mysqli_fetch_array($countf);

$counting = mysqli_query($conn,"select count(b.officer_id)as totallsing6 from positions_level as a,officers as b where a.l_id=b.l_id and a.l_name='$l_name'  and b.status_persions='ໂສດ'   and b.dateb_hp");
...
<th><?php echo $row['l_name']; ?></th>
<th><?php echo $tom['totalls6']; ?> ສະຫາຍ</th>
<th><?php echo $tof['totallsw6']; ?> ສະຫາຍ</th>
