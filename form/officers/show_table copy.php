...
$fileLink = "<a href='documents/{$file}' target='_blank'>📎 {$file}</a>";
}
}
...
<?php if ($_SESSION['role'] == "admin") { ?>
<td>
<a href="people_print.php?officer_id=<?= $row['officer_id'] ?>" class="btn btn-info btn-sm ">
<i class="ion-ios-printer"></i> ພີມ
</a>

<a href="show_table.php?officer_id=<?= $row['officer_id'] ?>" class="btn btn-danger btn-sm delete">
<i class="fas fa-trash"></i> ລົບ
</a>
<a href="edit.php?officer_id=<?= $row['officer_id'] ?>" class="btn btn-primary btn-sm edit">
